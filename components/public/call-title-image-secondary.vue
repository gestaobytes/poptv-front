<template>
  ...
  >
    <div style="background:">
      <p class="retract-lasts-posts mb-n1 mt-n2">{{fontData.retracts}}</p>
      <h1 class="title-lasts-posts-secondary-home" color="cyan">{{fontData.titleadapter}}</h1>
